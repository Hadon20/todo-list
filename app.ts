...
function main() {
    ...
    const form = document.querySelector('#chore-form') as HTMLFormElement
...
function getChoreFromUser(e: Event) {
    e.preventDefault()
    const choreInput = document.querySelector('.chores-input') as HTMLInputElement
...
function createChore(choreName: string) {
    const chore: Chore = {
        name: choreName,
        status: false,
...
function displayChores() {
    const choresList = document.querySelector('.chores-list') as HTMLDivElement
    choresList.innerHTML = ''

    let choresToDisplay: Chore[] = []
...
function updateChoreClass(element: HTMLElement, status: boolean) {
...
function updateCounter() {
    const choresCounter = document.querySelector('.chores-counter') as HTMLParagraphElement
...
function filterChores() {
    ...
    const filterActive = document.querySelector('#filter-active') as HTMLButtonElement
